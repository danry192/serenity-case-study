    ...
    return (
        <div className="section-title">
            ...
            <div className="section1">
                <h2 className="title">Registered Nurse (RN) Application</h2>
            ...
            <div className="form-container-careers">
                ...
                <form onSubmit={sendEmail}
                    ...
                    <div className="formItem">
                        <label className="label-jobs">First Name</label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Last Name</label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Email</label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Phone Number</label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Date of Birth</label>
                        <input placeholder="--/--/----"
                            name="birthday"
                            type="text"
                            className="birthday"
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Address</label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Address 2
              </label>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">City</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Choose a service:</label>
                        <select name="state">
                            <option>AL</option>
                            <option>AK</option>
                            <option>AZ</option>
                    ...
                    <div className="formItem">
                        <label className="label-jobs">Zip Code</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Work History 1</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Work History 2</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Work History 3</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Are you CPR Certified? (Mandatory)</label>
                        <select name="cpr">
                            <option>Yes</option>
                            <option>No</option>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Do you have a nursing certification? (Mandatory)</label>
                    ...
                    <div className="form-group">
                        <label className="label-jobs">Are you authorized to work in the United States?</label>
